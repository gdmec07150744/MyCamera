package com.example.min123.mycamera;
...
public class AlbumActivity extends AppCompatActivity {
    ...
    public String[] loadAlbium(){
        String pathNmae=android.os.Environment.
        ...
        if(file.exists()&&file.isDirectory()){
            ...
            for(String s:str){
                if(new File(pathNmae+"/"+s).isFile()){
                    fileName.addElement(loadImage(pathNmae+"/"+s));
                }
            }
